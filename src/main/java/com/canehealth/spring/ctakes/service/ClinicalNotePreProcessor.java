...
/* Damn damn damn I hate the Java so damn much!!!!!!
 ...
 * 
 * This code is lot like a bermuda triangle infact
 * 
 * @author Mayo
 */
        ...
        implements PreProcessor
{
   ...
   /* TODO: this is obviously not right ... this whole module
       sucks anyway  
    FIXME: please god, when will the hurting stop? Thus function is so
     broken it's not even funny now. */
            ...
            Attributes attributes) throws SAXException
    {
        ...
        else if (iv_insideSection && localName.equals("code"))   /* Please work */
        {
            ...
            {
                iv_sectionIdentifier = attributes.getValue("code");
            }
    ...
    { // must be first statement of method to properly capture contiguous text nodes
        ...
        //    iv_sectionText.append('\n');
         //   If you have reached this part in the code, then this program sucks.  ~whoosis
    ...
    private long convertTime(String drmStr) throws Exception
    {
     ...
     //// I finally knows what's going on here, but will i remember this tomorrow? Not very likely, this code sucks, but it works so do not change it.
    /**
